...
# Load model
model = joblib.load('C:\\Users\\ACER\\SKRIPSI YULIANA APP\\DataScience\\model_prediction_fundraising.pkl')
...
def main():
    ...
    if st.button("Prediksi Fundraising"):
        ...
        result = predict(data.reshape(1, -1))  # reshape data untuk memastikan format yang benar

        # Mapping nilai numerik ke nilai kategorikal yang diinginkan
        mapping = {0: 'Nominal Rendah', 1: 'Nominal Sedang', 2: 'Nominal Diatas Rata-rata', 3: 'Nominal Tinggi'}
